...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(525, 523, "end", "model_IPM_ICchinook_pp");
    return reader;
}
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(M_hat, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            SR(SR_fun, alpha_i, Mmax_i, get_base1(S, i, "S", 1), get_base1(A, i, "A", 1), pstream__), 
                            "assigning variable M_hat");
                current_statement_begin__ = 375;
                stan::model::assign(M0, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(M_hat, i, "M_hat", 1) * stan::math::exp((dot_product(get_base1(X_M, i, "X_M", 1), beta_M) + get_base1(epsilon_M, i, "epsilon_M", 1)))), 
            ...
            for (int i = 1; i <= (N_age - 1); ++i) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(sigma_pop_p, i, "sigma_pop_p", 1), 0, 3));
