...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(398, 396, "end", "model_IPM_SSpa_pp");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(zeta_R, 0, 1));
        ...
        try {
            ...
            for (int i = 1; i <= N_fwd; ++i) {
                ...
                stan::model::assign(R_hat_fwd, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(A_fwd, i, "A_fwd", 1) * SR(SR_fun, get_base1(alpha, get_base1(pop_fwd, i, "pop_fwd", 1), "alpha", 1), get_base1(Rmax, get_base1(pop_fwd, i, "pop_fwd", 1), "Rmax", 1), get_base1(S_fwd, i, "S_fwd", 1), get_base1(A_fwd, i, "A_fwd", 1), pstream__)), 
