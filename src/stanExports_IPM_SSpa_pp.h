...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(454, 452, "end", "model_IPM_SSpa_pp");
    return reader;
}
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(R_hat, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            SR(SR_fun, alpha_i, Rmax_i, multiply(multiply(get_base1(S, i, "S", 1), stan::model::rvalue(q, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "q")), age_S_eff), get_base1(A, i, "A", 1), pstream__), 
