...
#include "stanExports_IPM_ICchinook_pp.h"

RCPP_MODULE(stan_fit4IPM_ICchinook_pp_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_IPM_ICchinook_pp")
