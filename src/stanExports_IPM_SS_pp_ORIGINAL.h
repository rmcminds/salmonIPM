...
namespace model_IPM_SS_pp_ORIGINAL_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_IPM_SS_pp_ORIGINAL");
    reader.add_event(394, 392, "end", "model_IPM_SS_pp_ORIGINAL");
    return reader;
}
...
class model_IPM_SS_pp_ORIGINAL : public prob_grad {
private:
        int N;
        std::vector<int> pop;
        std::vector<int> year;
...
public:
    model_IPM_SS_pp_ORIGINAL(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_IPM_SS_pp_ORIGINAL_namespace::model_IPM_SS_pp_ORIGINAL";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_IPM_SS_pp_ORIGINAL_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_IPM_SS_pp_ORIGINAL";
    }
...
typedef model_IPM_SS_pp_ORIGINAL_namespace::model_IPM_SS_pp_ORIGINAL stan_model;
#endif
