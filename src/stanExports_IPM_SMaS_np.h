...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(434, 432, "end", "model_IPM_SMaS_np");
    return reader;
}
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_lte(get_base1(pop_year_indx, i, "pop_year_indx", 1), max_MSage))) {
                    ...
                    stan::math::assign(ii, (((get_base1(pop, i, "pop", 1) - 1) * max_MSage) + get_base1(pop_year_indx, i, "pop_year_indx", 1)));
                    ...
                    for (int sa = 1; sa <= N_Mage; ++sa) {
                        ...
                        stan::math::assign(q_GR_orphan, append_row(sum(head(stan::model::rvalue(get_base1(q_GR_init, ii, "q_GR_init", 1), stan::model::cons_list(stan::model::index_multi(aa), stan::model::nil_index_list()), "q_GR_init[ii]"), ((N_MSage - N_orphan_MSage) + 1))), tail(stan::model::rvalue(get_base1(q_GR_init, ii, "q_GR_init", 1), stan::model::cons_list(stan::model::index_multi(aa), stan::model::nil_index_list()), "q_GR_init[ii]"), (N_orphan_MSage - 1))));
                        current_statement_begin__ = 301;
                        for (int oa = 1; oa <= N_MSage; ++oa) {
                            current_statement_begin__ = 303;
                            if (as_bool(logical_lt(get_base1(ocean_ages, oa, "ocean_ages", 1), get_base1(pop_year_indx, i, "pop_year_indx", 1)))) {
                                ...
                                stan::model::assign(S_W_a, 
                                            stan::model::cons_list(stan::model::index_uni(sa), stan::model::cons_list(stan::model::index_uni(oa), stan::model::nil_index_list())), 
                                            ((get_base1(S_init, ii, "S_init", 1) * (1 - get_base1(p_HOS_all, i, "p_HOS_all", 1))) * get_base1(q_GR_orphan, (oa - (N_MSage - N_orphan_MSage)), "q_GR_orphan", 1)), 
                                            "assigning variable S_W_a");
                            }
                        }
                        }
