...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(280, 278, "end", "model_IPM_SMS_np");
    return reader;
}
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_lte(get_base1(pop_year_indx, i, "pop_year_indx", 1), max_age))) {
                    ...
                    stan::model::assign(q, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_min_max(1, N_age), stan::model::nil_index_list())), 
                                to_row_vector(stan::model::rvalue(q_init, stan::model::cons_list(stan::model::index_uni(ii), stan::model::cons_list(stan::model::index_min_max(1, N_age), stan::model::nil_index_list())), "q_init")), 
