...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(316, 314, "end", "model_IPM_SMS_np");
    return reader;
}
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int a = 1; a <= N_age; ++a) {
                    ...
                    if (as_bool(logical_lt((smolt_age + get_base1(ocean_ages, a, "ocean_ages", 1)), get_base1(pop_year_indx, i, "pop_year_indx", 1)))) {
