...
#include "stanExports_IPM_SS_pp_ORIGINAL.h"

RCPP_MODULE(stan_fit4IPM_SS_pp_ORIGINAL_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_IPM_SS_pp_ORIGINAL")
