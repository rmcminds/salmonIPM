...
namespace model_IPM_SS_pp_amalgamated_q_init_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_IPM_SS_pp_amalgamated_q_init");
    reader.add_event(422, 420, "end", "model_IPM_SS_pp_amalgamated_q_init");
    return reader;
}
...
#include <stan_meta_header.hpp>
 class model_IPM_SS_pp_amalgamated_q_init : public prob_grad {
private:
        int N;
        std::vector<int> pop;
        std::vector<int> year;
...
public:
    model_IPM_SS_pp_amalgamated_q_init(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_IPM_SS_pp_amalgamated_q_init_namespace::model_IPM_SS_pp_amalgamated_q_init";
    ...
    ~model_IPM_SS_pp_amalgamated_q_init() { }
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_lte(get_base1(pop_year_indx, i, "pop_year_indx", 1), max_age))) {
                    ...
                    (void) N_orphan_age;  // dummy to suppress unused var warning
                    stan::math::fill(N_orphan_age, std::numeric_limits<int>::min());
                    stan::math::assign(N_orphan_age,(N_age - std::max((get_base1(pop_year_indx, i, "pop_year_indx", 1) - min_age), 0)));
                    ...
                    lp_accum__.add(lognormal_log<propto__>(get_base1(S_init, ii, "S_init", 1), stan::math::log(((1.0 * N_orphan_age) / N_age)), 10));
                    current_statement_begin__ = 341;
                    lp_accum__.add(dirichlet_log<propto__>(get_base1(q_init, ii, "q_init", 1), append_row(rep_vector((1.0 / N_amalg_age), N_amalg_age), rep_vector(1, (N_orphan_age - 1)))));
                    }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_IPM_SS_pp_amalgamated_q_init_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_IPM_SS_pp_amalgamated_q_init";
    }
...
typedef model_IPM_SS_pp_amalgamated_q_init_namespace::model_IPM_SS_pp_amalgamated_q_init stan_model;
