...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(279, 277, "end", "model_IPM_SS_np");
    return reader;
}
...
class model_IPM_SS_np
  : public stan::model::model_base_crtp<model_IPM_SS_np> {
private:
        int N;
        std::vector<int> pop;
        std::vector<int> year;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            mu_Rmax = double(0);
            stan::math::fill(mu_Rmax, DUMMY_VAR__);
            stan::math::assign(mu_Rmax,quantile(stan::math::log(stan::model::rvalue(S_obs, stan::model::cons_list(stan::model::index_multi(which_S_obs), stan::model::nil_index_list()), "S_obs")), 0.9, pstream__));
            current_statement_begin__ = 77;
            sigma_Rmax = double(0);
            stan::math::fill(sigma_Rmax, DUMMY_VAR__);
            stan::math::assign(sigma_Rmax,sd(stan::math::log(stan::model::rvalue(S_obs, stan::model::cons_list(stan::model::index_multi(which_S_obs), stan::model::nil_index_list()), "S_obs"))));
