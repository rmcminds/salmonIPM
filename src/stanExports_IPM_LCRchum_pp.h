...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(367, 365, "end", "model_IPM_LCRchum_pp");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(lognormal_log<propto__>(stan::model::rvalue(M_obs, stan::model::cons_list(stan::model::index_multi(which_M_obs), stan::model::nil_index_list()), "M_obs"), stan::math::log(stan::model::rvalue(M, stan::model::cons_list(stan::model::index_multi(which_M_obs), stan::model::nil_index_list()), "M")), tau_M_obs));
            current_statement_begin__ = 336;
            lp_accum__.add(lognormal_log<propto__>(stan::model::rvalue(S_obs, stan::model::cons_list(stan::model::index_multi(which_S_obs), stan::model::nil_index_list()), "S_obs"), stan::math::log(stan::model::rvalue(S, stan::model::cons_list(stan::model::index_multi(which_S_obs), stan::model::nil_index_list()), "S")), tau_S_obs));
        ...
        try {
            ...
            for (int i = 1; i <= N_M_obs; ++i) {
                ...
                stan::model::assign(LL_M_obs, 
                            ...
                            lognormal_log(get_base1(M_obs, get_base1(which_M_obs, i, "which_M_obs", 1), "M_obs", 1), stan::math::log(get_base1(M, get_base1(which_M_obs, i, "which_M_obs", 1), "M", 1)), get_base1(tau_M_obs, i, "tau_M_obs", 1)), 
            ...
            for (int i = 1; i <= N_S_obs; ++i) {
                ...
                stan::model::assign(LL_S_obs, 
                            ...
                            lognormal_log(get_base1(S_obs, get_base1(which_S_obs, i, "which_S_obs", 1), "S_obs", 1), stan::math::log(get_base1(S, get_base1(which_S_obs, i, "which_S_obs", 1), "S", 1)), get_base1(tau_S_obs, i, "tau_S_obs", 1)), 
