...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(394, 392, "end", "model_IPM_LCRchum_pp");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(tau_M, rep_vector(mu_tau_M, N));
            ...
            stan::math::assign(tau_S, rep_vector(mu_tau_S, N));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("LL_tau_M_obs");
        names__.push_back("LL_tau_S_obs");
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("LL_tau_M_obs", "N", N);
            Eigen::Matrix<double, Eigen::Dynamic, 1> LL_tau_M_obs(N);
            stan::math::initialize(LL_tau_M_obs, DUMMY_VAR__);
            stan::math::fill(LL_tau_M_obs, DUMMY_VAR__);
            current_statement_begin__ = 364;
            validate_non_negative_index("LL_tau_S_obs", "N", N);
            Eigen::Matrix<double, Eigen::Dynamic, 1> LL_tau_S_obs(N);
            stan::math::initialize(LL_tau_S_obs, DUMMY_VAR__);
            stan::math::fill(LL_tau_S_obs, DUMMY_VAR__);
            ...
            stan::math::assign(LL_tau_M_obs, rep_vector(0, N));
            current_statement_begin__ = 375;
            for (int i = 1; i <= N_tau_M_obs; ++i) {
                current_statement_begin__ = 376;
                stan::model::assign(LL_tau_M_obs, 
                            stan::model::cons_list(stan::model::index_uni(get_base1(which_tau_M_obs, i, "which_tau_M_obs", 1)), stan::model::nil_index_list()), 
                            lognormal_log(get_base1(tau_M_obs, get_base1(which_tau_M_obs, i, "which_tau_M_obs", 1), "tau_M_obs", 1), stan::math::log(mu_tau_M), sigma_tau_M), 
                            "assigning variable LL_tau_M_obs");
            }
            current_statement_begin__ = 377;
            stan::math::assign(LL_tau_S_obs, rep_vector(0, N));
            current_statement_begin__ = 378;
            for (int i = 1; i <= N_tau_S_obs; ++i) {
                current_statement_begin__ = 379;
                stan::model::assign(LL_tau_S_obs, 
                            stan::model::cons_list(stan::model::index_uni(get_base1(which_tau_S_obs, i, "which_tau_S_obs", 1)), stan::model::nil_index_list()), 
                            lognormal_log(get_base1(tau_S_obs, get_base1(which_tau_S_obs, i, "which_tau_S_obs", 1), "tau_S_obs", 1), stan::math::log(mu_tau_S), sigma_tau_S), 
                            "assigning variable LL_tau_S_obs");
            }
            ...
            for (int i = 1; i <= N_M_obs; ++i) {
                ...
                stan::model::assign(LL_M_obs, 
                            ...
                            lognormal_log(get_base1(M_obs, get_base1(which_M_obs, i, "which_M_obs", 1), "M_obs", 1), stan::math::log(get_base1(M, get_base1(which_M_obs, i, "which_M_obs", 1), "M", 1)), get_base1(tau_M, get_base1(which_M_obs, i, "which_M_obs", 1), "tau_M", 1)), 
            ...
            for (int i = 1; i <= N_S_obs; ++i) {
                ...
                stan::model::assign(LL_S_obs, 
                            ...
                            lognormal_log(get_base1(S_obs, get_base1(which_S_obs, i, "which_S_obs", 1), "S_obs", 1), stan::math::log(get_base1(S, get_base1(which_S_obs, i, "which_S_obs", 1), "S", 1)), get_base1(tau_S, get_base1(which_S_obs, i, "which_S_obs", 1), "tau_S", 1)), 
            ...
            stan::math::assign(LL, add(add(add(add(LL_tau_M_obs, LL_tau_S_obs), LL_M_obs), LL_S_obs), LL_n_age_obs));
            ...
            current_statement_begin__ = 363;
            size_t LL_tau_M_obs_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < LL_tau_M_obs_j_1_max__; ++j_1__) {
                vars__.push_back(LL_tau_M_obs(j_1__));
            }
            current_statement_begin__ = 364;
            size_t LL_tau_S_obs_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < LL_tau_S_obs_j_1_max__; ++j_1__) {
                vars__.push_back(LL_tau_S_obs(j_1__));
            }
            current_statement_begin__ = 365;
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < LL_tau_M_obs_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "LL_tau_M_obs" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t LL_tau_S_obs_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < LL_tau_S_obs_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "LL_tau_S_obs" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t LL_M_obs_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < LL_M_obs_j_1_max__; ++j_1__) {
