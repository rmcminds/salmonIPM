...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(484, 482, "end", "model_IPM_LCRchum_pp");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "N_X_psi", "int", context__.to_vec());
            N_X_psi = int(0);
            vals_i__ = context__.vals_i("N_X_psi");
            pos__ = 0;
            N_X_psi = vals_i__[pos__++];
            check_greater_or_equal(function__, "N_X_psi", N_X_psi, 0);
            current_statement_begin__ = 56;
            validate_non_negative_index("X_psi", "N_X_psi", N_X_psi);
            validate_non_negative_index("X_psi", "N", N);
            context__.validate_dims("data initialization", "X_psi", "row_vector_d", context__.to_vec(N,N_X_psi));
            X_psi = std::vector<Eigen::Matrix<double, 1, Eigen::Dynamic> >(N, Eigen::Matrix<double, 1, Eigen::Dynamic>(N_X_psi));
            vals_r__ = context__.vals_r("X_psi");
            pos__ = 0;
            size_t X_psi_j_1_max__ = N_X_psi;
            size_t X_psi_k_0_max__ = N;
            for (size_t j_1__ = 0; j_1__ < X_psi_j_1_max__; ++j_1__) {
                for (size_t k_0__ = 0; k_0__ < X_psi_k_0_max__; ++k_0__) {
                    X_psi[k_0__](j_1__) = vals_r__[pos__++];
                }
            }
            ...
            validate_non_negative_index("beta_psi", "N_X_psi", N_X_psi);
            num_params_r__ += N_X_psi;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("beta_psi", "N_X_psi", N_X_psi);
        context__.validate_dims("parameter initialization", "beta_psi", "vector_d", context__.to_vec(N_X_psi));
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_psi(N_X_psi);
        size_t beta_psi_j_1_max__ = N_X_psi;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                beta_psi = in__.vector_constrain(N_X_psi, lp__);
            else
                beta_psi = in__.vector_constrain(N_X_psi);
            current_statement_begin__ = 164;
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::math::assign(psi_i,(get_base1(psi, get_base1(pop, i, "pop", 1), "psi", 1) * stan::math::exp(dot_product(get_base1(X_psi, i, "X_psi", 1), beta_psi))));
                ...
                stan::math::assign(Mmax_i,(get_base1(Mmax, get_base1(pop, i, "pop", 1), "Mmax", 1) * stan::math::exp(dot_product(get_base1(X_Mmax, i, "X_Mmax", 1), beta_Mmax))));
                ...
                stan::model::assign(M_hat, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            SR(SR_fun, psi_i, (Mmax_i * 1e3), get_base1(E_hat, i, "E_hat", 1), get_base1(A, i, "A", 1), pstream__), 
            ...
            lp_accum__.add(normal_log<propto__>(beta_psi, 0, 5));
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta_psi = in__.vector_constrain(N_X_psi);
        size_t beta_psi_j_1_max__ = N_X_psi;
        for (size_t j_1__ = 0; j_1__ < beta_psi_j_1_max__; ++j_1__) {
