...
#' are given priors), `"shared"` (`pop`- or `year`-level parameters shared by multiple states),
...
stan_pars <- function(stan_model = c("IPM_SS_np","IPM_SSiter_np","IPM_SS_pp","IPM_SSiter_pp",
                                     ...
                                     "RR_SS_np","RR_SS_pp"), 
                      pars = c("all","hyper","shared","states","ppd")) 
{
  ...
  par_list <- list( 
    ...
    IPM_SS_pp = list(
      ...
      shared = c("alpha","Rmax","eta_year_R","mu_pop_alr_p"),
      states = c("R","p","S","q","p_HOS")
    ),
    ...
    IPM_SSiter_pp = list(
      ...
      shared = c("alpha","Rmax","eta_year_R","mu_pop_alr_p","eta_year_SS"),
    ...
    IPM_SMS_pp = list(
      ...
      shared = c("alpha","Mmax","eta_year_M","eta_year_MS","mu_pop_alr_p"),
      states = c("M","s_MS","p","S","q","p_HOS")
    ),
    ...
    IPM_ICchinook_pp = list(
      hyper = c("mu_alpha","beta_alpha","sigma_alpha","mu_Mmax","beta_Mmax","sigma_Mmax",
                ...
                "mu_p","sigma_pop_p","R_pop_p","sigma_p","R_p","tau_S"),
      shared = c("alpha","Mmax","s_D","SAR","s_U","mu_pop_alr_p"),
    ...
    IPM_LCRchum_pp = list(
      ...
      shared = c("psi","Mmax","eta_year_M","eta_year_MS","mu_pop_alr_p"),
    ...
    RR_SS_pp = list(
      ...
      shared = c("alpha","Rmax","eta_year_R"),
