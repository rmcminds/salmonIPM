...
stan_pars <- function(stan_model) {
  pars <- list( 
    IPM_SS_np = c("alpha","Rmax","beta_R","rho_R","sigma_R",
                  "mu_p","sigma_p","R_p","p",
                  "p_HOS","B_rate","tau","S","R","q"),
