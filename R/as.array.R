...
#'
#' Post-warmup samples from a [salmonIPMfit] object are converted into standard
...
#'
#' @return A `matrix`, `array` or `data.frame` containing the post-warmup
#'   samples of the specified quantities.
#'
