...
#' @param alpha A numeric vector, matrix, data frame, [posterior::rvar()],
...
#' @param Rmax A numeric vector, matrix, data frame, [posterior::rvar()], or `draws` of 
...
#' @param S A numeric vector, matrix, data frame, [posterior::rvar()], or `draws` of 
#'   spawner abundance.
